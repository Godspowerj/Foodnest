...
export default function WalletPage() {
  return (
    <div className=" bg-[#fdf8f6] h-screen overflow-y-scroll scrollbar-hide w-full px-4 py-5">
      ...
      <div className="max-w-xl mx-auto  rounded-2xl shadow-xl overflow-hidden">
        <h1 className="text-2xl font-bold text-[#6e4231] py-2">Hello Jonah</h1>
        {/* Balance Section */}
        ...
        <div className="px-6 py-4 bg-[#fff6f2]">
          <h3 className="text-lg font-semibold mb-2 text-[#6e4231]">
            Rewards & Promos
          </h3>
          ...
          <div className="bg-white rounded-xl shadow p-4 text-center">
            <p className="text-sm text-gray-600">
              Use promo code{" "}
              <span className="font-bold text-[#6e4231]">EATWELL</span> for ₦500
              off your next meal
            </p>
          </div>
        </div>
        ...
        <div className="px-6 py-4 bg-[#fff6f2] rounded-b-2xl">
          <h3 className="text-lg font-semibold text-[#6e4231] mb-2">
            Loyalty Rewards
          </h3>
          <p className="text-sm text-gray-600 mb-2">
            3 orders away from a free meal
          </p>
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div
              className="bg-[#6e4231] h-2 rounded-full"
              style={{ width: "70%" }}
            ></div>
          </div>
        </div>
